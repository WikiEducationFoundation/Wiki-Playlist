    ...
    return (
      <div className='home container'>
        <div className='prose home-copy'>
          <h2>Welcome to the Wiki Playlist!</h2>
          <p>We’re excited to see what you share! Here’s how to get started.</p>
          <ol>
            <li className='mb1'>Click the blue-green “Create a Playlist” button on the top right corner to go to the Playlist creator. Name your Playlist, for example, “Exploring the Universe with Wiki.” </li>
            ...
            <li className='mb1'>Then, “Add Wiki Article.” Typing in any topic will load a smart search so you can find the article on the topic you’re looking for. Review the article and then “Add to Playlist.” </li>
