(function() {
  ...
  Share = (function() {
    ...
    Share.prototype.platforms = [
      {
        ...
        name: "tumblr",
        sdk_url: "http://platform.tumblr.com/v1/share.js",
    ...
    Share.prototype.initTumblr = function(platform) {
      if ($('[data-share-tumblr]').length === 0) {
        return;
      }
      return $.getScript(platform.sdk_url, (function(_this) {
        return function() {
          return _this.initTumblrInteractions();
        };
      })(this));
    };
