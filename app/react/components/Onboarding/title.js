      ...
      <div className='card onboarding__title mb2 md-flex'>
        <div className='p2 flex flex-column onboarding__column'>
          <div>
            ...
            <p className='mb2 caption'>Celebrate the joy of knowledge by creating a Playlist of your 3–5 favorite Wiki articles, then sharing your Playlist on social media.</p>
          </div>
          <div>
